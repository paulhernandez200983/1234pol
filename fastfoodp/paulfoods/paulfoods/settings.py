"""
Django settings for paulfoods project.
...
SECRET_KEY = 'django-insecure-sv)3$pk78gwy6vqf#pks3po9zl*pw)7d38pokp2x!n)qzv%ye7'
...
WSGI_APPLICATION = 'paulfoods.wsgi.application'
