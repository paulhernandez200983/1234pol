...
def agregar_al_carrito(request, chicken_id):
    ...
    return redirect('food:actividad')
...
def chicken(request):
    ...
    context = {
        ...
        'active_link': 'actividad',  # Add your active link logic here
    }
...
def ver_carrito_y_pagar(request):
    ...
    return render(request, 'foods/ver_carrito_y_pagar.html', {'items_carrito': items_carrito, 'subtotal': total_carrit, 'total':total_carrito, 'puntos':puntos_deducidos})
